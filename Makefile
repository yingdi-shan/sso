...
benchmark: benchmark.cpp
	$(CC) benchmark.cpp -o benchmark $(CC_FLAG) -lcppnetlib-client-connections -lcppnetlib-uri -lboost_system -lboost_thread -lpthread -lssl 

server: web.o mysql.o data_access.o
	$(CC)  web.o mysql.o data_access.o -ldl -ltbb -lmysqlcppconn-static -L/usr/lib64/mysql -ltcmalloc -lmysqlclient -lpthread -lboost_system -o server $(CC_FLAG)
